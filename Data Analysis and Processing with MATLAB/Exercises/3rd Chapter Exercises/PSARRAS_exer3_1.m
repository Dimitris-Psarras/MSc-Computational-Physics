...
for i=1:r
    ...
    mu=simulation_poiss(lamda,n,M);
    % Print of the average value of the sample means and the parameters of
    % the simulation
    formatspec = 'The average value of the sample means is %8.4f. The simulation has M=%d samples of size n=%d and lamda=%d \n';
    fprintf(formatspec,mu,M,n,lamda);
end