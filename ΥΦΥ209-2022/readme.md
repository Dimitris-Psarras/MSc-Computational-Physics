...
2. __Figures__, which includes the printed figures from the execution of the python code
    ...
    2. __Figure2.png__ is the replicated FIG 2. regarding the Configurational entropy (continuous line) and mass (dotted line) versus polytropic index γ for $ρ_0=ρ_c$.
