# &Upsilon$&Phi$\Upsilon$209-2022 Project
...
2. __Figures__, which includes the printed figures from the execution of the python code
    ...
    2. __Figure2.png__ is the replicated FIG 2. regarding the Configurational entropy times &rho$_0^{-1} (continuous line) and mass (dotted line) versus polytropic index &gamma for $&rho_0=&rho_c$.
